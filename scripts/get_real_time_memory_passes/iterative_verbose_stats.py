...
base_command = ['gtime', '-v', './bin/main', 'RUN_ALGO']
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-o", "--output-dir",
        default="./results/real/verbose_stats",
        help="Directory to save the results (default: ./results/real/verbose_stats)"
    )
