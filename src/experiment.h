...
ExpResult experimentFramework(bool runMode, int experiment_type, ll n, ll M, int sparsity, string graph_type, int iterations, ll seed_token, int algorithm = 0, int algo_variant = 0, ll k = 0);
