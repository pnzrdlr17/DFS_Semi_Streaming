...
// new code starts from below: backedges thing
...
// heuristic - total nk space + marked/unmarked
...
// heuristic - total nk space + marked/unmarked + top path klev heuristic
